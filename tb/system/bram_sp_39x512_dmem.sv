`timescale 1ns/1ps
// bram_sp_39x512_dmem.sv — Simulation model for DMEM Vivado BRAM IP (512-deep)
// Identical behaviour to bram_sp_39x512 but distinct module name so
// Vivado can use a separate IP instance with its own COE init file.

module bram_sp_39x512_dmem #(
    parameter MEM_INIT = ""
)(
    input  logic        clka,
    input  logic        wea,
